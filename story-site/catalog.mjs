...
export const archaeologyAnchors = Object.freeze([
  ...
  },
  {
    ...
    revision: '3e709b98af21ce70d183388e09be1f83fb2c5635',
    path: 'Lore/fork-tales',
    relation: 'A later corpus organized material as characters, creative works, events, and world records.',
  },
  {
    id: 'world-console',
    label: 'World console interface',
    repository: 'octave-commons/fork_tales',
    revision: 'c6357ebf6126114792f343301e18f5ca10c4c016',
    path: 'part64/frontend',
    relation: 'The existing React interface is a simulation/operator console, not a public story reader.',
  },
  {
    id: 'code-witness',
